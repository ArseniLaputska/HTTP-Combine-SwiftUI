          ...
          if self.imageLoader.image != nil {
            ...
            if imageLoader.url != nil {
              Rectangle()
                ...
                .frame(width: UIScreen.main.bounds.width * 0.75, height: UIScreen.main.bounds.width * 0.6, alignment: .center)
                .scaledToFit()
                .overlay(
                  Text("Loading...")
                    .font(.footnote)
                    ...
                    .onAppear { withAnimation(Animation.easeInOut(duration: 1.0).repeatForever()) { self.animate = true}
                    }
                ) // overlay
            } else {
              EmptyView()
